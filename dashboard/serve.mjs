...
function seedAgentActionCatalog(state = {}) {
  ...
  return [
    ...
    { id: 'aac-content-generator', category: 'content', icon: 'content', name: 'Content generator', status: 'queued', summary: 'Turns audit patterns, wins, objections, and proof into posts, landing copy, ads, and proposal snippets.', specialistAgent: 'content generator / non-ai-slop copy specialist', tools: ['copy templates', 'receipts/proof inputs', 'brand rules', 'local draft writer'], inputsNeeded: ['topic/use case', 'proof receipt', 'audience', 'channel', 'CTA'], outputs: ['local content drafts', 'variant list', 'approval-ready copy'], outputCount: 0, lastRun: 'not run', nextRun: 'after proof/win receipts', costCreditRisk: 'low', approvalShort: 'draft only', approvalPolicy: commonApproval, receipts: [receiptsPath, 'local draft artifact path'], escalationTriggers: ['public post requested', 'unsupported claim', 'customer name/logo use', 'compliance-sensitive copy'] },
